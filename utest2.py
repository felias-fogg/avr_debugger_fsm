...
def read_signature():
    ...
    logger.info("Trying to read signature")
    target.protocol.memory_read(Avr8Protocol.AVR8_MEMTYPE_SIGNATURE, 0, 3)
    logger.info("signature read")
...
def read_sram():
    ...
    """
    global target, logger
    logger.info("Trying to read from SRAM")
    target.protocol.memory_read(Avr8Protocol.AVR8_MEMTYPE_SRAM, 0x100, 2)
    logger.info("Read from SRAM")
